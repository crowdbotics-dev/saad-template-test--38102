...
## Project Structure
    ...
    ├── saad_template_test__38102  # Django project configurations
...
1. Clone this repo and `cd saad_template_test__38102`
...
2. Clone this repo and `cd saad_template_test__38102`
